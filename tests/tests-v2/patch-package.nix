...
(testLib.runTests {
  ...
  testPatchDepRegistry = {
    expr =
      let
        res = (
          i.patchPackage noSourceOptions "node_modules/yallist" {
            version = "4.0.0";
      ...
      [
        (res.version == "4.0.0")
        (lib.hasPrefix "file:///nix/store" res.resolved)
        (
          res.integrity
  ...
  testPatchDepRegistryWithQueryString = {
    expr =
      let
        res = (
          i.patchPackage noSourceOptions "node_modules/@rjsf/bootstrap-5" {
            version = "4.2.0";
      ...
      [
        (res.version == "4.2.0")
        (lib.hasPrefix "file:///nix/store" res.resolved)
        (lib.hasSuffix ".tgz" res.resolved)
        (
          res.integrity
  ...
  testPatchDepGithub = {
    expr =
      let
        res = (
          i.patchPackage noSourceOptions "node_modules/leftpad" {
            version = "0.0.1";
            resolved = "git+ssh://git@github.com/tmcw/leftpad.git#db1442a0556c2b133627ffebf455a78a1ced64b9";
