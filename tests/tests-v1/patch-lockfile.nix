...
testLib.runTests {
  ...
  testPatchDependencyHandlesGitHubRefsInRequires = {
    expr =
      let
        libxmljsUrl =
          (npmlock2nix.v1.internal.patchDependency [ ] noSourceOptions "test" {
  ...
  testPatchLockfileWithoutDependencies = {
    expr =
      (npmlock2nix.v1.internal.patchLockfile noSourceOptions ./examples-projects/no-dependencies/package-lock.json)
      .result.dependencies;
    expected = { };
  };
  ...
  testPatchLockfileTurnsUrlsIntoStorePaths = {
    expr =
      let
        deps =
          (npmlock2nix.v1.internal.patchLockfile noSourceOptions ./examples-projects/single-dependency/package-lock.json)
          .result.dependencies;
      in
  ...
  testPatchLockfileTurnsGitHubUrlsIntoStorePaths = {
    expr =
      let
        leftpad =
          (npmlock2nix.v1.internal.patchLockfile noSourceOptions ./examples-projects/github-dependency/package-lock.json)
          .result.dependencies.leftpad;
      in
  ...
  testConvertPatchedLockfileToJSON = {
    expr =
      builtins.typeOf (
        builtins.toJSON (npmlock2nix.v1.internal.patchLockfile noSourceOptions ./examples-projects/nested-dependencies/package-lock.json)
        .result
      ) == "string";
    expected = true;
  };
  ...
  testPatchedLockFile = {
    expr = testLib.hashFile (npmlock2nix.v1.internal.patchedLockfile noSourceOptions ./examples-projects/nested-dependencies/package-lock.json)
    .result;
